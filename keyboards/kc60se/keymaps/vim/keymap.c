...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT_60_ansi_split_bs_rshift(
        ...
        KC_LGUI, KC_LALT, MO(_FL),                   KC_SPC,                                      MO(_FL), KC_RGUI, KC_RALT, KC_RCTL \
    ),
    [_FL] = LAYOUT_60_ansi_split_bs_rshift(
        ...
        KC_CAPS, _______, _______, _______, _______, _______, BL_ON,   BL_STEP, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, KC_DEL, \
        _______, _______, _______, _______, KC_PGDN, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, _______, \
        _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, KC_PGUP, _______, _______, _______,  _______, _______, _______, _______, \
 ...
 *'--------------------------------------------------------------------------'
 * FL -  h,j,k,l,^f,^b - vim movement keys
 *.--------------------------------------------------------------------------.
 *|    | f1 | f2 | f3 | f4 | f5 | f6 | f7 | f8 | f9 | f10| f11| f12|    | ins|
 *|--------------------------------------------------------------------------|
 *| caps |    |    |    |    |    |blon|blup|    |    |pscr|slck|paus|  del  |
 *|--------------------------------------------------------------------------|
