...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT_60_ansi_split_bs_rshift(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_M,    KC_C,    KC_V,    KC_K,    KC_L,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(_FL), \
 ...
 *|------------------------------------------------------------------------- |
 *|lctl   | a  | s  | h  | t  | g  | y  | n  | e  | o  | i  | '  |  enter    |
 *|------------------------------------------------------------------------- |
 *|shift    | z  | x  | m  | c  | v  | k  | l  | ,  | .  | /  |shift  |mo(FL)|
 *|------------------------------------------------------------------------- |
