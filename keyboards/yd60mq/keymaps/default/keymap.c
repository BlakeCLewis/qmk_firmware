...
// clang-format off
	[_BL] = LAYOUT_minila(
		...
		KC_LCTL, KC_LGUI, KC_LALT, MO(_FL),                            KC_SPC,  MO(_FL), KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT)
    ),
	...
	[_FL] = LAYOUT_minila(
		...
		TG(_WK), _______, TG(_ML), _______,                            _______, _______, _______, _______, _______, _______, _______),
